...
eval("var v1='<rd-widget><rd-widget-header icon={{icon}} title={{name}}></rd-widget-header><rd-widget-body><canvas class=\"chart chart-line\" chart-data=data chart-labels=labels chart-legend=true chart-series=series chart-click=config.onClick></canvas></rd-widget-body></rd-widget>';\nangular.module('panel-widgets').run(['$templateCache', function ($templateCache) {$templateCache.put('panel-widgets/src/templates/chart-widget.html', v1);}]);\nmodule.exports=v1\n\n//# sourceURL=webpack://panelWidgets/./src/templates/chart-widget.html?");
